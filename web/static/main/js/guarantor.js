...
(function() {
    ...
    Vue.component('guarantor', {
        ...
        template: [
            ...
            '        </div>',
            '      </div>',
            '      <div v-if="primaryWallet && primaryWallet.address" class="p-6 bg-white rounded-2xl border border-[#eff2f5] shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">',
