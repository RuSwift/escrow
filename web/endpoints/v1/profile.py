...
def _user_to_profile_response(user) -> ProfileResponse:
...
async def get_web3_me(current_user: CurrentWeb3User, wallet_service: WalletUserServiceDep):
...
async def get_tron_me(current_user: CurrentTronUser, wallet_service: WalletUserServiceDep):
...
async def get_user_profile(identifier: str, wallet_service: WalletUserServiceDep):
